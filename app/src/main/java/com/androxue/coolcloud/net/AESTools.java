package com.androxue.coolcloud.net;
...
/**
 * Created by JimCharles on 2017/3/27.
 */
    ...
    public static String encrpty(String paramString) {
        ...
        try {
            ...
            return URLEncoder.encode(
                    ...
                    "utf-8");
        } catch (NoSuchAlgorithmException | NoSuchPaddingException | InvalidKeyException | UnsupportedEncodingException | InvalidAlgorithmParameterException | BadPaddingException | IllegalBlockSizeException e) {
            e.printStackTrace();
        }
        return "";
    }
